...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.category'
        db.add_column(u'notorhot_competition', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notorhot.CandidateCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.category'
        db.delete_column(u'notorhot_competition', 'category_id')
