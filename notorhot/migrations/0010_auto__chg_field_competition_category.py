...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.category'
        db.alter_column(u'notorhot_competition', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['notorhot.CandidateCategory']))

    def backwards(self, orm):

        # Changing field 'Competition.category'
        db.alter_column(u'notorhot_competition', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notorhot.CandidateCategory'], null=True))
